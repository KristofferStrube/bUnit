...
namespace Bunit.TestDoubles
{
	...
	/// <summary>
	/// Exception use to indicate that an unplanned IJSInProcess invocation was
	/// received by the <see cref="MockJSRuntimeInvokeHandler"/> running in <see cref="JSRuntimeMockMode.Strict"/>.
	/// </summary>
	public class UnplannedIJSInProcessInvocationException : Exception
	{
		/// <summary>
		/// Gets the unplanned invocation.
		/// </summary>
		public IJSInProcessRuntimeInvocation Invocation { get; }
		...
		/// </summary>
		/// <param name="invocation">The unplanned invocation.</param>
		public UnplannedIJSInProcessInvocationException(IJSInProcessRuntimeInvocation invocation)
			: base($"The invocation of '{invocation.Identifier}' {PrintArguments(invocation.Arguments)} was not expected.")
		{
			Invocation = invocation;
		}
